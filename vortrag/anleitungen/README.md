# Anleitungs-Sheets zum DHBW-Abendvortrag

Diese drei Markdown-Sheets führen vom leeren Obsidian-Vault bis zur nutzbaren LaTeX-Thesis-Vorlage mit KI-Unterstützung.

Empfohlene Reihenfolge:

1. [`01-start-ki-einrichten.md`](01-start-ki-einrichten.md) - Einstieg: Obsidian-Vault, Claude Code oder OpenAI Codex, `CLAUDE.md`/`AGENTS.md`, erste KI-Session.
